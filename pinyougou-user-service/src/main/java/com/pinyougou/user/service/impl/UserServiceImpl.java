...
public class UserServiceImpl implements UserService {
    ...
    @Value("${success_template_code}")
    private String success_template_code;
    ...
    @Override
    public void succesMessage(final String name, final String phone) {
        jmsTemplate.send(smsDestination, new MessageCreator() {
            @Override
            public Message createMessage(Session session) throws JMSException {
                MapMessage message = session.createMapMessage();
                ...
                message.setString("mobile", phone);
                //验证码
                message.setString("template_code", success_template_code);
                //签名
                message.setString("sign_name", sign_name);
                Map map = new HashMap();
                map.put("name", name);
